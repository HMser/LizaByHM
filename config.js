...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? '𝐋𝐔𝐓𝐓𝐀𝐏𝐏𝐈' : process.env.ALL_CAPTION,
    ...
    GIF_WEL: process.env.GIF_WEL === undefined ? 'https://i.imgur.com/JfZrdYI.mp4' : process.env.GIF_WEL,
    GIF_BYE: process.env.GIF_BYE === undefined ? 'https://i.imgur.com/SMnyrQN.mp4' : process.env.GIF_BYE,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? '𝐋𝐔𝐓𝐓𝐀𝐏𝐏𝐈 𝐁𝐎𝐓' : process.env.BOT_NAME,
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://i.imgur.com/0MwO1yz.jpeg' : process.env.ALL_IMG,
