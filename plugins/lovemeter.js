...
if (con.LANG === 'TR') {
    ...
    if (con.WORKTYPE === 'private') {
        ...
        Asena.addCommand({pattern: 'lovemeter', fromMe: true, desc: TRGAY}, (async (message, match) => {
        ...
        Asena.addCommand({pattern: 'lovemeter', fromMe: false, desc: TRGAY}, (async (message, match) => {
    ...
    if (con.WORKTYPE === 'private') {
        ...
        Asena.addCommand({pattern: 'lovemeter', fromMe: true, desc: HIGAY}, (async (message, match) => {
        ...
        Asena.addCommand({pattern: 'Lovemeter', fromMe: false, desc: HIGAY}, (async (message, match) => {
    ...
    if (con.WORKTYPE === 'private') {
        ...
        Asena.addCommand({pattern: 'lovemeter', fromMe: true, desc: AZGAY}, (async (message, match) => {
        ...
        Asena.addCommand({pattern: 'lovemeter', fromMe: false, desc: AZGAY}, (async (message, match) => {
    ...
    if (con.WORKTYPE === 'private') {
        ...
        Asena.addCommand({pattern: 'lovemeter', fromMe: true, desc: ENGAY}, (async (message, match) => {

            if (message.reply_message === false) return await message.client.sendMessage(message.jid, ENREP, MessageType.text);

            await message.client.sendMessage(message.jid, '*Calculating Your Love towards* ' + '@' + message.reply_message.jid.split('@')[0] + ' ❤️💞', MessageType.text, {
                quotedMessage: message.reply_message.data, contextInfo: {mentionedJid: [message.reply_message.jid.replace('c.us', 's.whatsapp.net')]}
        ...
        Asena.addCommand({pattern: 'lovemeter', fromMe: false, desc: ENGAY}, (async (message, match) => {
