...
if (con.LANG === 'TR') {
    ...
    if (con.WORKTYPE === 'private') {
        ...
        Asena.addCommand({pattern: 'brometer', fromMe: true, desc: TRGAY}, (async (message, match) => {
        ...
        Asena.addCommand({pattern: 'brometer', fromMe: false, desc: TRGAY}, (async (message, match) => {
    ...
    if (con.WORKTYPE === 'private') {
        ...
        Asena.addCommand({pattern: 'brometer', fromMe: true, desc: HIGAY}, (async (message, match) => {
        ...
        Asena.addCommand({pattern: 'brometer', fromMe: false, desc: HIGAY}, (async (message, match) => {
    ...
    if (con.WORKTYPE === 'private') {
        ...
        Asena.addCommand({pattern: 'brometer', fromMe: true, desc: AZGAY}, (async (message, match) => {
        ...
        Asena.addCommand({pattern: 'brometer', fromMe: false, desc: AZGAY}, (async (message, match) => {
    ...
    if (con.WORKTYPE === 'private') {
        ...
        Asena.addCommand({pattern: 'brometer', fromMe: true, desc: ENGAY}, (async (message, match) => {
            ...
            await message.client.sendMessage(
                ...
                fs.readFileSync("/root/WhatsAsenaDuplicated/media/gif/brometer.mp4"),
                MessageType.video, 
                { mimetype: Mimetype.gif, caption: `*Brotherhood Calculated*\n*Result:* ${r_text[i]} %` }
            )
        }));
    }
    else if (con.WORKTYPE === 'public') {

        Asena.addCommand({pattern: 'brometer', fromMe: false, desc: ENGAY}, (async (message, match) => {
